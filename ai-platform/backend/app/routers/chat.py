from app.ai.client import resolve_model  # noqa: F401 (kept for clarity, not directly used here)
...
async def send_message(
    ...
    reply_text, _ = run_conversation(claude_messages, model=payload.model)
