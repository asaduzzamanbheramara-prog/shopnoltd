...
declare -A HOSTS=(
  ...
  [metabase]="metabase.shopnoltd.dpdns.org"
  [n8n]="n8n.shopnoltd.dpdns.org"
  [nextcloud]="nextcloud.shopnoltd.dpdns.org"
  [onlyoffice]="onlyoffice.shopnoltd.dpdns.org"
  [owncast]="owncast.shopnoltd.dpdns.org"
  [superset]="superset.shopnoltd.dpdns.org"
  [minio]="minio.shopnoltd.dpdns.org"
  [opensearch]="opensearch.shopnoltd.dpdns.org"
  ...
  [mail-service]="mail-api.shopnoltd.dpdns.org"
  [alertmanager]="alertmanager.shopnoltd.dpdns.org"
  [grafana]="grafana.shopnoltd.dpdns.org"
  [loki]="loki.shopnoltd.dpdns.org"
  [prometheus]="prometheus.shopnoltd.dpdns.org"
  [billing-engine]="billing-engine.shopnoltd.dpdns.org"
  ...
  [search-service]="search-service.shopnoltd.dpdns.org"
