...
# Generate a placeholder logo if you don't have one
# Replace with: cp /path/to/your/real-logo.png "$ASSET_DIR/shopnoltd-logo.png"
convert -size 512x512 \
  ...
  "$ASSET_DIR/shopnoltd-logo.png" 2>/dev/null || true

# Smaller variants
convert "$ASSET_DIR/shopnoltd-logo.png" -resize 192x192 "$ASSET_DIR/shopnoltd-logo-192.png" 2>/dev/null
convert "$ASSET_DIR/shopnoltd-logo.png" -resize 96x96   "$ASSET_DIR/shopnoltd-logo-96.png"  2>/dev/null
convert "$ASSET_DIR/shopnoltd-logo.png" -resize 48x48   "$ASSET_DIR/shopnoltd-logo-48.png"  2>/dev/null

# favicon
convert "$ASSET_DIR/shopnoltd-logo-48.png" "$ASSET_DIR/favicon.ico" 2>/dev/null

# Windows .ico (multi-size)
convert "$ASSET_DIR/shopnoltd-logo-48.png" \
        "$ASSET_DIR/shopnoltd-logo-96.png" \
        "$ASSET_DIR/shopnoltd-logo-192.png" \
        "$ASSET_DIR/shopnoltd.ico" 2>/dev/null
