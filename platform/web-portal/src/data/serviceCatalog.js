...
export const SERVICES = [
  ...
  SERVICE('💰', 'Payments & Wallet', 'Payment methods, deposits, transactions and wallet operations.', 'https://api.shopnoltd.dpdns.org/openapi.json', 'Business'),
...
export const ADMIN_SERVICES = [
  ...
  SERVICE('💰', 'Payment Administration', 'Manage payment transactions, deposits, wallets and provider operations.', 'https://api.shopnoltd.dpdns.org/openapi.json', 'Finance'),
