export const SERVICES = [
  ...
  },
  {
    icon: '🦊',
    name: 'Git',
    description: 'Git repositories and collaborative source control.',
    url: 'https://gitea.shopnoltd.dpdns.org',
    category: 'Developer',
  },
  {
    icon: '🔗',
...
export const CONNECTED_PLATFORMS = [
  ...
  },
  {
    icon: '👤',
    name: 'Profiles',
    description: 'Manage personal, creator, developer and business profiles.',
    url: '/dashboard',
  },
  {
    icon: '📧',
    name: 'Mail',
    description: 'Access Shopnoltd Mail and connected email workflows.',
    url: 'https://mail.shopnoltd.dpdns.org',
  },
  {
    icon: '💬',
