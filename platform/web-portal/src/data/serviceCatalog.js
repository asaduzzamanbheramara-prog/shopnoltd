...
export const SERVICES = [
  ...
  SERVICE('✉️', 'Mail', 'Shopnoltd mailbox and email workflows through the secure webmail client.', 'https://webmail.shopnoltd.dpdns.org', 'Communication'),
...
export const ADMIN_SERVICES = [
  ...
  SERVICE('🤖', 'AI Model Administration', 'Manage AI providers and models, activation, defaults, connectivity tests and credentials from the authorized admin workspace.', '/admin/ai-models', 'Administration'),
