...
export const ADMIN_SERVICES = [
  ...
  SERVICE('💳', 'Billing Administration', 'Manage plans, subscriptions, invoices and billing operations.', '/admin', 'Finance'),
  SERVICE('💰', 'Payment Administration', 'Manage payment transactions, deposits, wallets and provider operations.', '/admin', 'Finance'),
  SERVICE('💱', 'Exchange Administration', 'Manage exchange/rate workflows and supported financial operations.', '/admin', 'Finance'),
  SERVICE('📡', 'Remote Device Administration', 'Manage authorized remote-device services and sessions.', '/admin', 'Remote Access'),
  SERVICE('🔧', 'GitOps / Deployment', 'Authorized deployment and synchronization control through the Shopnoltd administration layer.', '/admin/infrastructure', 'Infrastructure'),
]
