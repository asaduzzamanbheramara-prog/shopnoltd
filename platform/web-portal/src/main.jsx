...
function App() {
  return <BrowserRouter><Nav /><SubdomainRedirect /><Routes>
    ...
    <Route path="/blog" element={<Blog />} /><Route path="/blog/:slug" element={<BlogPost />} /><Route path="/plugins" element={<Plugins />} /><Route path="/services" element={<Services />} /><Route path="/downloads" element={<Downloads />} /><Route path="/phone" element={<Phone />} /><Route path="/domain-registration" element={<DomainRegistration />} />
