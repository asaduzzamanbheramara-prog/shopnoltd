      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'flex-end', gap: '8px 16px', minWidth: 0 }}>
        ...
        {loggedIn && <>
          ...
          {isAdmin && <>
            ...
            <Link to="/admin/infrastructure" style={{ color: 'white', textDecoration: 'none', padding: '6px 2px', fontWeight: location.pathname.startsWith('/admin/infrastructure') ? 700 : 400 }}>Infrastructure</Link>
          </>}
