...
const PUBLIC_LINKS = [['Pricing', '/pricing'], ['Discover', '/discover'], ['Feed', '/feed'], ['Work', '/work'], ['Blog', '/blog'], ['AI', '/ai'], ['Services', '/services'], ['Domains', '/domain-registration'], ['Android Cloud', 'https://devices.shopnoltd.dpdns.org/']]
...
function App() {
  return <BrowserRouter><Nav /><SubdomainRedirect /><Routes>
    <Route path="/" element={<Home />} /><Route path="/pricing" element={<Pricing />} /><Route path="/discover" element={<ProtectedRoute><Discover /></ProtectedRoute>} /><Route path="/feed" element={<ProtectedRoute><SocialFeed /></ProtectedRoute>} /><Route path="/post/:id" element={<ProtectedRoute><PostDetail /></ProtectedRoute>} />
