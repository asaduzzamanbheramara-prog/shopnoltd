...
export default function AccountHub() {
  ...
  const [me, setMe] = useState(() => decodeToken(localStorage.getItem('shopno_token') || ''))
  const [notifications, setNotifications] = useState([])
  useEffect(() => {
    setMe(decodeToken(localStorage.getItem('shopno_token') || ''))
