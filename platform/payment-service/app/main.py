...
import structlog
from app.api import admin, admin_tables, admin_reports, admin_backups, deposits, direct_mfs_feed, direct_payments, exchanges, methods, transactions, transfers, wallets, webhooks, withdrawals
...
app.include_router(direct_mfs_feed.router, prefix="/api/v1/direct-payments", tags=["direct-mfs-feed"])
