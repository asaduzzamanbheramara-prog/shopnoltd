...
async def verify(request: Request):
    ...
    try:
        ...
        h = {
            "X-Forwarded-User": payload.get("sub", ""),
            "X-Forwarded-Email": payload.get("email", ""),
            "X-Forwarded-Tenant": payload.get("tenant_id", "default"),
            "X-Forwarded-Roles": ",".join(payload.get("roles", [])),
        }
